...
class AtHomeReportInterceptorTest {
    @Test
    fun success_reportsBytesDurationAndCacheState() =
        runTest {
    ...
    @Test
    fun networkFailure_reportsFailureWithZeroBytes() =
        runTest {
            val repository = mockk<MangaRepository>(relaxed = true)
            val scope = TestScope(testScheduler)
            val client =
    ...
    @Test
    fun mangadexOrgImage_isSkipped() =
        runTest {
            val repository = mockk<MangaRepository>(relaxed = true)
            val scope = TestScope(testScheduler)
            val client =
    ...
    @Test
    fun skipHeader_goBoHeaderVaKhongReport() =
        runTest {
            val repository = mockk<MangaRepository>(relaxed = true)
            val scope = TestScope(testScheduler)
    ...
    @Test
    fun success_khongCoXCache_reportCachedFalse() =
        runTest {
            val repository = mockk<MangaRepository>(relaxed = true)
            val scope = TestScope(testScheduler)
            val client =
